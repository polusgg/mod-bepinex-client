...
namespace PolusGG {
    public static class AccountMenu {
        ...
        public static void InitializeAccountMenu(Scene scene) {
            ...
            if (!loaded) {
                _objects.Add(PogusPlugin.Bundle.LoadAsset("Assets/Mods/LoginMenu/PogusAccountMenu.prefab")
                    .Cast<GameObject>().DontDestroy());
                _objects.Add(PogusPlugin.Bundle.LoadAsset("Assets/Mods/LoginMenu/TopAccount.prefab").Cast<GameObject>()
                    .DontDestroy());
                loaded = true;
            }
